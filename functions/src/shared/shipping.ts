...
export const INTL_DELIVERY_BASE_LAMPORTS = 250_000_000;
export const INTL_DELIVERY_EXTRA_LAMPORTS = 50_000_000;
const LITTLE_SWAG_BOXES_US_BASE_LAMPORTS = 100_000_000;
const LITTLE_SWAG_BOXES_US_EXTRA_LAMPORTS = 25_000_000;
export const CARD_NFT_2_BASE_DELIVERY_CARD_COUNT = 3;
