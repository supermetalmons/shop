...
export const DEPLOYMENT_DROPS: DeploymentDropsMap = {
  ...
  clear_cards_devnet: {
    ...
    discountMintsPerWallet: 1,
    discountMerkleRoot: '5ac73d2313e0d003a1d7c7510caf6c171f1841f7c06715c498bf0c5e15dfacc3',
    maxSupply: 192,
    itemsPerBox: 1,
    maxPerTx: 15,
    namePrefix: 'pack',
    ...
    receiptsMerkleTree: '4hdDaxgywfq7i4Frs2R1WbX7qYeBqUnMq9ge711jxhGW',
    receiptsTreeMaxDepth: 14,
    receiptsTreeCanopyDepth: 0,
    deliveryLookupTable: '68v5vvNbFbiCNtz8BWackb3G8iQVGEnpi8XYDchARmpn',
  },
  drifella_shirt: {
    solanaCluster: 'mainnet-beta',
