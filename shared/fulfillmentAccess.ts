import { DEPLOYMENT_DROPS } from './deploymentRegistry.ts';
...
export const CARD_FULFILLMENT_DROP_IDS: readonly string[] = Object.freeze([
  'card_nft_2',
  'clear_cards',
]);
...
const CARD_NFT_BINDER_SHIPPER_DROP_IDS: readonly string[] = Object.freeze(
