/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: daed59e6735652b0eb34311b020bcedf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HELIUS_API_KEY" | "RESEND_CONTACTS_API_KEY" | "NOTIFICATION_ENQUEUE_SECRET" | "FIRESTORE_SERVICE_ACCOUNT_JSON">> {}
}
