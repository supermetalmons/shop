/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env --strict-vars=false cloud/workers/api/worker-configuration.d.ts` (hash: 6b75bbe9669a17fdf1d963e678757196)
