/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: 471a2a35a4312790db8d7b5426cd4952)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HELIUS_API_KEY" | "RESEND_CONTACTS_API_KEY" | "NOTIFICATION_ENQUEUE_SECRET" | "FIRESTORE_SERVICE_ACCOUNT_JSON" | "ADDRESS_DECRYPTION_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_RESTRICTED_KEY" | "STRIPE_SECRET_KEY_LIVE" | "STRIPE_RESTRICTED_KEY_LIVE">> {}
}
