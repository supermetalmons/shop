/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env --strict-vars=false cloud/workers/api/worker-configuration.d.ts` (hash: 8a0816bf1f6b6b2408952db1bc7fbd69)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 enable_request_signal,nodejs_compat
interface __BaseEnv_Env {
	DATA_DB: D1Database;
	OPS_DB: D1Database;
	COMMERCE_DB: D1Database;
	NOTIFICATION_EMAIL_QUEUE: Queue;
	REVEAL_BACKGROUND_QUEUE: Queue;
	STRIPE_FULFILLMENT_QUEUE: Queue;
	PREORDER_PREPARE_RATE_LIMITER: RateLimit;
	PREORDER_PREPARE_IP_RATE_LIMITER: RateLimit;
	STAFF_AUTH_CHALLENGE_RATE_LIMITER: RateLimit;
	STAFF_AUTH_SESSION_RATE_LIMITER: RateLimit;
	ANONYMOUS_AUTH_SESSION_RATE_LIMITER: RateLimit;
	PUBLIC_RPC_READ_RATE_LIMITER: RateLimit;
	PUBLIC_RPC_WRITE_RATE_LIMITER: RateLimit;
	PUBLIC_SHOP_RATE_LIMITER: RateLimit;
	PUBLIC_NOTIFICATION_RATE_LIMITER: RateLimit;
	STRIPE_RECEIPT_CLAIM_ADMISSION_ENABLED: string;
	ALCHEMY_MI_NOTE_API_KEY: string;
	OPENSEA_API_KEY: string;
	HELIUS_API_KEY: string;
	COSIGNER_SECRET: string;
	RESEND_API_KEY: string;
	RESEND_CONTACTS_API_KEY: string;
	NOTIFICATION_ENQUEUE_SECRET: string;
	ADDRESS_DECRYPTION_SECRET: string;
	SHIPSTATION_API_KEY: string;
	SHIPSTATION_SHIP_FROM: string;
	STRIPE_SECRET_KEY: string;
	STRIPE_RESTRICTED_KEY: string;
	STRIPE_SECRET_KEY_LIVE: string;
	STRIPE_RESTRICTED_KEY_LIVE: string;
	STRIPE_WEBHOOK_SECRET_DEVNET: string;
	STRIPE_WEBHOOK_SECRET: string;
	ADMIN_IRL_REDEEM_FINALIZE_WORKFLOW: Workflow<Parameters<import("./src/index").AdminIrlRedeemFinalizeWorkflowV1['run']>[0]['payload']>;
	STRIPE_RECEIPT_CLAIM_WORKFLOW: Workflow<Parameters<import("./src/index").StripeReceiptClaimWorkflowV1['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRIPE_RECEIPT_CLAIM_ADMISSION_ENABLED" | "ALCHEMY_MI_NOTE_API_KEY" | "OPENSEA_API_KEY" | "HELIUS_API_KEY" | "COSIGNER_SECRET" | "RESEND_API_KEY" | "RESEND_CONTACTS_API_KEY" | "NOTIFICATION_ENQUEUE_SECRET" | "ADDRESS_DECRYPTION_SECRET" | "SHIPSTATION_API_KEY" | "SHIPSTATION_SHIP_FROM" | "STRIPE_SECRET_KEY" | "STRIPE_RESTRICTED_KEY" | "STRIPE_SECRET_KEY_LIVE" | "STRIPE_RESTRICTED_KEY_LIVE" | "STRIPE_WEBHOOK_SECRET_DEVNET" | "STRIPE_WEBHOOK_SECRET">> {}
}
