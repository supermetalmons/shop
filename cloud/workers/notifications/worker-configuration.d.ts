/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/notifications/wrangler.jsonc --env-file=cloud/workers/notifications/release.env cloud/workers/notifications/worker-configuration.d.ts` (hash: b2d0d9e2e140776d78a8d385432c2351)
