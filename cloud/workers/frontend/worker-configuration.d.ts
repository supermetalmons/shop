/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=cloud/workers/frontend/release.env cloud/workers/frontend/worker-configuration.d.ts` (hash: bcc615441e13eccccb085dc6e4ceac44)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 enable_request_signal,nodejs_compat,request_signal_passthrough
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	MONS_API: Fetcher /* mons-shop-api */;
}
